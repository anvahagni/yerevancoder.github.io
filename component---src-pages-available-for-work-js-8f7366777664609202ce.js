...
/***/ (function(module, exports, __webpack_require__) {
	...
	var addMilliseconds = __webpack_require__(81)
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _ModalPortal = __webpack_require__(94);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _focusManager = __webpack_require__(96);
	
	var focusManager = _interopRequireWildcard(_focusManager);
	
	var _scopeTab = __webpack_require__(97);
	...
	var _classList = __webpack_require__(95);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _PageView = __webpack_require__(100);
	
	var _PageView2 = _interopRequireDefault(_PageView);
	
	var _BreakView = __webpack_require__(99);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _PaginationBoxView = __webpack_require__(101);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _freelancerPost = __webpack_require__(57);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _freelanceProfileView = __webpack_require__(61);
	
	var _freelanceProfileView2 = _interopRequireDefault(_freelanceProfileView);
	
	var _hiringSubmissionsProfileView = __webpack_require__(62);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _submitInput = __webpack_require__(12);
	
	var _submitInput2 = _interopRequireDefault(_submitInput);
	
	var _withEffectInput = __webpack_require__(13);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _newsBannerModule = __webpack_require__(84);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _reactPaginate = __webpack_require__(102);
	...
	var _tempData = __webpack_require__(70);
	
	var _tempData2 = _interopRequireDefault(_tempData);
	
	var _newsBanner = __webpack_require__(68);
	
	var _newsBanner2 = _interopRequireDefault(_newsBanner);
	
	var _newsModule = __webpack_require__(85);
	
	var _newsModule2 = _interopRequireDefault(_newsModule);
	
	var _srcCommon = __webpack_require__(56);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _add_minutes = __webpack_require__(82);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _profileControl = __webpack_require__(63);
	
	var _profileControl2 = _interopRequireDefault(_profileControl);
	
	var _newFreelancer = __webpack_require__(66);
	
	var _newFreelancer2 = _interopRequireDefault(_newFreelancer);
	
	var _freelancerTable = __webpack_require__(58);
	...
	var _jobsTable = __webpack_require__(60);
	
	var _jobsTable2 = _interopRequireDefault(_jobsTable);
	
	var _newJobPosting = __webpack_require__(67);
	
	var _newJobPosting2 = _interopRequireDefault(_newJobPosting);
	
	var _signinBar = __webpack_require__(72);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _pageControl = __webpack_require__(71);
	...
	var ADD_YOURSELF = 'Add yourself';
	
	var NEW_FREELANCER = 'New freelancer';
	...
	var INIT_STATE = {
	  ...
	  page_content: _constants.PAGE_CONTENT.FREELANCER_TABLE,
	  modal_profile_content: _constants.MODAL_PROFILE_CONTENT.FREELANCER_POSTING
	};
	
	var AvailableForWorkPage = function (_React$Component) {
	  _inherits(AvailableForWorkPage, _React$Component);
	
	  function AvailableForWorkPage() {
	    var _temp, _this, _ret;
	
	    _classCallCheck(this, AvailableForWorkPage);
	    ...
	    return _ret = (_temp = (_this = _possibleConstructorReturn(this, _React$Component.call.apply(_React$Component, [this].concat(args))), _this), _this.state = _extends({}, INIT_STATE), _this.query_data = function () {
	      return _db.freelancers_posts_ref.once('value').then(function (snap_shot) {
	        return snap_shot.val();
	      });
	    }, _this.delete_my_freelance_posting = function () {
	      if (_this.state.self_freelance_posting) {
	        var post_key = _this.state.self_freelance_posting.post_key;
	
	        var current_user = _db.firebase.auth().currentUser;
	        _db.db.ref('users/' + current_user.uid + '/my-freelance-submission').remove().then(function () {
	          return _db.freelancers_posts_ref.child(post_key).remove();
	        }).then(function () {
	          return _this.query_data().then(function (rows) {
	            return _this.setState(function () {
	              return {
	                self_freelance_posting: null,
	                page_content: _constants.PAGE_CONTENT.FREELANCER_TABLE,
	                freelancers: rows ? (0, _funcs.obj_to_array)(rows) : []
	              };
	            });
	          });
	        }).catch(function (error) {
	    ...
	    }, _this.all_freelance_data = function () {
	      return _this.query_data().then(function (rows) {
	        return (0, _funcs.query_my_freelance_submission)().then(function (self_freelance_posting) {
	          return {
	            freelancers: rows ? (0, _funcs.obj_to_array)(rows) : [],
	            self_freelance_posting: self_freelance_posting
	          };
	    ...
	    }, _this.post_signin_action = function () {
	      _this.all_freelance_data().then(function (_ref) {
	        var freelancers = _ref.freelancers,
	            self_freelance_posting = _ref.self_freelance_posting;
	    ...
	    }, _this.freelancer_post_did_finish = function () {
	      _this.all_freelance_data().then(function (_ref2) {
	        var freelancers = _ref2.freelancers,
	            self_freelance_posting = _ref2.self_freelance_posting;
	    ...
	    }, _this.toggle_freelancer_content = function () {
	      return _this.setState(function (_ref3) {
	        var page_content = _ref3.page_content;
	        return {
	          page_content: page_content === _constants.PAGE_CONTENT.FREELANCER_TABLE ? _constants.PAGE_CONTENT.NEW_FREELANCER : _constants.PAGE_CONTENT.FREELANCER_TABLE
	        };
	      });
	    }, _this.already_signed_in_page_handler = function (after_cb) {
	      (0, _funcs.query_my_freelance_submission)().then(function (self_freelance_posting) {
	        return _this.setState(function () {
	          return {
	            self_freelance_posting: self_freelance_posting,
	      ...
	      _this.setState(function (prev_state) {
	        return {
	          page_content: prev_state.page_content === _constants.PAGE_CONTENT.FREELANCER_TABLE ? _constants.PAGE_CONTENT.NEW_FREELANCER : _constants.PAGE_CONTENT.FREELANCER_TABLE
	        };
	      });
	  ...
	  AvailableForWorkPage.prototype.componentDidMount = function componentDidMount() {
	    var _this2 = this;
	  ...
	  AvailableForWorkPage.prototype.render = function render() {
	    return _react2.default.createElement(_pageControl2.default, {
	      ...
	      new_tech_job_post_did_finish: _funcs.no_op,
	      did_finish_submit_post_lifecycle: this.freelancer_post_did_finish,
	      submit_new_hiring_post: _funcs.no_op,
	      ...
	      custom_input_signed_in_name: this.state.page_content === _constants.PAGE_CONTENT.NEW_FREELANCER ? 'Freelancers' : ADD_YOURSELF,
	  ...
	  return AvailableForWorkPage;
	}(_react2.default.Component);
	
	AvailableForWorkPage.contextTypes = {
	  authenticated_user: _propTypes2.default.func,
	  sign_user_out: _propTypes2.default.func,
	  sign_user_in: _propTypes2.default.func,
	  submit_new_freelancer_post: _propTypes2.default.func
	};
	AvailableForWorkPage.displayName = 'AvailableForWorkPage';
	exports.default = AvailableForWorkPage;
	module.exports = exports['default'];

/***/ })

});
//# sourceMappingURL=component---src-pages-available-for-work-js-8f7366777664609202ce.js.map