...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.default = (0, _reactRouterDom.withRouter)((_temp2 = _class = function (_React$Component) {
	  ...
	  News.prototype.query_total_news_postings_count = function query_total_news_postings_count() {
	    _db.total_news_posting_count_ref.once('value').then(function (snap_shot) {
	      return Number(snap_shot.val());
	    });
	  };
	
	  News.prototype.test_push_data = function test_push_data() {
	    var _context = this.context,
	        submit_new_news_post = _context.submit_new_news_post,
	        authenticated_user = _context.authenticated_user;
	  ...
	  News.prototype.current_page_number = function current_page_number() {
	  ...
	  News.prototype.componentDidMount = function () {
	    var _ref2 = _asyncToGenerator(function* () {
	      ...
	      var _ref3 = yield (0, _funcs.computed_news_posts)({
	        page_index: page
	      }),
	          result = _ref3.result,
	          error = _ref3.error;
...
//# sourceMappingURL=component---src-pages-available-for-work-js-f296356bcd48eb378cfe.js.map