...
/***/ (function(module, exports) {
	...
	module.exports = {"data":{"site":{"siteMetadata":{"title":"yerevancoder"}},"allMarkdownRemark":{"edges":[{"node":{"timeToRead":1}},{"node":{"timeToRead":8}},{"node":{"timeToRead":10}},{"node":{"timeToRead":1}},{"node":{"timeToRead":1}},{"node":{"timeToRead":1}},{"node":{"timeToRead":10}},{"node":{"timeToRead":12}},{"node":{"timeToRead":1}},{"node":{"timeToRead":2}},{"node":{"timeToRead":3}},{"node":{"timeToRead":12}},{"node":{"timeToRead":3}},{"node":{"timeToRead":3}},{"node":{"timeToRead":4}},{"node":{"timeToRead":8}},{"node":{"timeToRead":4}},{"node":{"timeToRead":7}},{"node":{"timeToRead":6}},{"node":{"timeToRead":12}},{"node":{"timeToRead":7}},{"node":{"timeToRead":14}},{"node":{"timeToRead":2}},{"node":{"timeToRead":1}},{"node":{"timeToRead":2}},{"node":{"timeToRead":4}},{"node":{"timeToRead":3}},{"node":{"timeToRead":2}},{"node":{"timeToRead":1}},{"node":{"timeToRead":1}}]}},"layoutContext":{}}
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _layoutIndex = __webpack_require__(156);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */(function(global) {var now = __webpack_require__(519)
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _raf = __webpack_require__(523);
	
	var _raf2 = _interopRequireDefault(_raf);
	
	var _shouldUpdate2 = __webpack_require__(589);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.default = function (_ref) {
	  var header_content = _ref.header_content;
	  return _react2.default.createElement(
	    'aside',
	    ...
	    _react2.default.createElement(
	      ...
	      _react2.default.createElement(
	        ...
	        { to: _constants.ROUTES.AVAILABLE_FOR_WORK },
	        'Find freelancers'
	      ),
	      ' looking for a job, or post a tech job on our ',
	      _react2.default.createElement(
	        _gatsbyLink2.default,
	        { to: _constants.ROUTES.JOBS_TABLE },
	        'hiring board'
	      ),
	      '. Check out our',
	      ' ',
	      _react2.default.createElement(
	        'a',
	        { href: 'https://forum.yerevancoder.com/categories' },
	        'forums'
	      ),
	      ' for more discussions, consider coming to ',
	      _react2.default.createElement(
	        'a',
	        { href: 'https://iteratehackerspace.com' },
	        'iterate hackerspace'
	      ),
	      ' for coding workshops and a vibrant programmer community.'
	    ),
	    _react2.default.createElement(
	      'p',
	      null,
	      ...
	      _react2.default.createElement(
	        _gatsbyLink2.default,
	        { to: '/2018-03-13-how-yerevan-coder-works/' },
	        'post'
	      ),
	      ' as a guide on how to add a new blog post and check out this',
	      ' ',
	      _react2.default.createElement(
	        _gatsbyLink2.default,
	        { to: '/2017-12-21-javascript-resources/' },
	        'post'
	      ),
	      ' for many inpage lecture notes on learning JavaScript, consider checking out the source code',
	      ' ',
	      _react2.default.createElement(
	        'a',
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var yc = _react2.default.createElement(
	  _gatsbyLink2.default,
	  { className: 'BlogTable__MobileBarBanner', to: '/' },
	  'yerevancoder'
	);
	
	exports.default = _react2.default.createElement(
	  'div',
	  { className: 'BlogTable__MobileBar' },
	  _react2.default.createElement('img', { className: 'BlogTable__MobileBarSiteLogo', src: '/mobile-bar-logo.png' }),
	  yc,
	  _react2.default.createElement(
	    'div',
	    { className: 'BlogTable__MobileBarNavBox PlainFlexRow' },
	    _react2.default.createElement(
	      'div',
	      { className: 'PlainFlexColumn BlogTable__MobileBarNavBoxElement' },
	      _react2.default.createElement(
	        _gatsbyLink2.default,
	        { to: _constants.ROUTES.AVAILABLE_FOR_WORK },
	        'freelancers'
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var yc = _react2.default.createElement(
	  _gatsbyLink2.default,
	  { className: 'InformationBar__SiteBannerName', to: '/' },
	  'yerevancoder'
	);
	...
	var INIT_STATE = {
	  ...
	  pin_bar_content: _constants.EMPTY_DIV
	};
	...
	var ApplicationRoot = function (_React$Component) {
	  ...
	  function ApplicationRoot() {
	    ...
	    return _ret = (_temp = (_this = _possibleConstructorReturn(this, _React$Component.call.apply(_React$Component, [this].concat(args))), _this), _this.state = _extends({}, INIT_STATE), _this.pass_through = function (_ref) {
	      ...
	      return _this.setState(function () {
	        return { pin_bar_content: _constants.EMPTY_DIV };
	      });
	    }, _this.onUnfix = function () {
	      return _this.setState({ pin_bar_content: _constants.EMPTY_DIV });
	    }, _this.onPin = function () {
	      return _this.setState({ pin_bar_content: _mobileBar2.default });
	  ...
	  ApplicationRoot.prototype.getChildContext = function getChildContext() {
	    ...
	    return {
	      authenticated_user: function authenticated_user() {
	        return _this2.state.authenticated_user;
	      },
	      sign_user_up: function sign_user_up(given_username, given_email, given_password, user_receives_blog_newsletter, did_signup_and_update) {
	        return _db.firebase.auth().createUserAndRetrieveDataWithEmailAndPassword(given_email, given_password).catch(function (error) {
	          throw new Error('Could not sign you up because:\n' + error.message);
	        }).then(function (reply) {
	          var authenticated_user = _this2.pass_through(reply.user);
	          var current_user = _db.firebase.auth().currentUser;
	          return _db.db.ref('signed-up-users/' + current_user.uid).set({ user_receives_blog_newsletter: user_receives_blog_newsletter, given_email: given_email, given_username: given_username }).then(function () {
	            return current_user.updateProfile({ displayName: given_username });
	          }).then(function () {
	            _this2.setState(function () {
	              return { authenticated_user: authenticated_user };
	            }, did_signup_and_update);
	          });
	        });
	      },
	      sign_user_in: function sign_user_in(email, password, remember_me_checked, did_signin_and_update) {
	        return _db.auth.signInWithEmailAndPassword(email, password).then(function (reply) {
	          return _this2.setState(function () {
	            return { remember_me_checked: remember_me_checked, authenticated_user: _this2.pass_through(reply) };
	          }, did_signin_and_update);
	        });
	      },
	      sign_user_out: function sign_user_out(after_sign_out) {
	        return _db.auth.signOut().then(function () {
	          _this2.setState(function () {
	            return _extends({}, INIT_STATE);
	          }, after_sign_out);
	        });
	      },
	      submit_new_freelancer_post: function submit_new_freelancer_post(data) {
	        return (0, _funcs.query_my_freelance_submission)().then(function (profile) {
	          if (profile === null) {
	            return _db.freelancers_posts_ref.push(data).then(function (reply) {
	              var uid = _this2.state.authenticated_user.uid;
	
	              return _db.db.ref('users/' + uid + '/my-freelance-submission').set(_extends({}, data, { post_key: reply.key }));
	            });
	          } else {
	      ...
	      submit_new_hiring_post: function submit_new_hiring_post(hiring_post) {
	        return _db.hiring_table_posts_ref.push().then(function (reply) {
	          var uid = _this2.state.authenticated_user.uid;
	
	          var new_post_key = reply.key;
	          var updates = {};
	          var with_info = _extends({}, hiring_post, { post_key: new_post_key });
	          updates['/hiring-table-posts/' + new_post_key] = with_info;
	          updates['/users/' + uid + '/my-hiring-board-submissions/' + new_post_key] = with_info;
	          return _db.db.ref().update(updates);
	        });
	      },
	      submit_new_news_post: function () {
	        var _ref2 = _asyncToGenerator(function* (news_post) {
	          var uid = _this2.state.authenticated_user.uid;
	
	          var reply = yield _db.news_postings_ref.push();
	          var current_count = yield _db.total_news_posting_count_ref.once('value').then(function (snap_shot) {
	            return Number(snap_shot.val());
	          });
	          var new_post_key = reply.key;
	          var updates = {};
	          var with_info = _extends({}, news_post, { post_key: new_post_key, post_creation_id: current_count });
	        ...
	        return function submit_new_news_post(_x) {
	  ...
	  ApplicationRoot.prototype.render = function render() {
	    ...
	    var site_title = this.props.data.site.siteMetadata.title;
	    return _react2.default.createElement(
	      'div',
	      { className: 'ApplicationContainer__Container' },
	      _react2.default.createElement(
	        _reactHelmet2.default,
	        { title: site_title },
	        _constants.global_styles,
	        _react2.default.createElement('link', { rel: 'stylesheet', href: '/normalize.css' }),
	        _react2.default.createElement('link', { rel: 'stylesheet', href: '/yc-styles.css' }),
	      ...
	      _react2.default.createElement(_fixedSidebar2.default, { header_content: yc }),
	      _react2.default.createElement(
	        'div',
	        { className: 'ApplicationContainer__MainContent' },
	        _react2.default.createElement(
	          _reactHeadroom2.default,
	          { pinStart: 300, onPin: this.onPin, onUnpin: this.onUnpin, onUnfix: this.onUnfix },
	          this.state.pin_bar_content
	        ),
	        _react2.default.createElement(
	          'div',
	          { className: 'ApplicationContainer__BusinessContent' },
	          children()
	        )
	      )
	    );
	...
	ApplicationRoot.childContextTypes = {
	  ...
	  sign_user_up: _propTypes2.default.func,
...
//# sourceMappingURL=component---src-layouts-index-js-0bd3b9fe8a2a71a4e283.js.map