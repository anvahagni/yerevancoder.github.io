...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.default = function (_ref) {
	  ...
	  var tag_names = new Set(tags.split(',').map(function (s) {
	    return s.trim().toLowerCase();
	  }));
	  var siteTitle = data.site.siteMetadata.title;
	  return _react2.default.createElement(
	    'div',
	    { className: 'BlogPost__PostContainer' },
	    ...
	    _react2.default.createElement('div', { className: '', dangerouslySetInnerHTML: { __html: post.html } }),
	    _react2.default.createElement('hr', null),
	    tag_names.has('javascript') ? _react2.default.createElement('iframe', {
	      height: '400px',
	      width: '100%',
	    ...
	    _react2.default.createElement(
	      ...
	      _react2.default.createElement(
	        'a',
	        { href: 'http://forum.yerevancoder.com' },
	        'forums'
	      ),
	      ' for more discussions, and if you like what you read, then join',
	      ' ',
	      _react2.default.createElement(
	        'a',
	        { href: 'http://iteratehackerspace.com' },
	        'iterate hackerspace'
	      ),
	      ' for a community of programmers in Yerevan for coding workshops, coding community.'
	    ),
	    _react2.default.createElement('hr', null),
...
//# sourceMappingURL=component---src-templates-blog-post-js-0af96f7020a1b2b37af1.js.map